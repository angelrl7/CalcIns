    ...
    <section className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
      ...
      >
        <span className="flex items-center gap-2">
          <span className="text-base font-semibold text-slate-800">Parámetros personales</span>
          {allSet
            ? <span className="text-xs bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-medium">configurados</span>
            : <span className="text-xs bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full font-medium">incompletos</span>
          }
        </span>
        <svg
      ...
      {open && (
        <div className="border-t border-slate-100 px-4 pb-5 pt-3 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mb-2">Según tu lapicera o bomba de insulina</p>
